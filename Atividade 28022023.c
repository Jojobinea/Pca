...
int main()
{
    char equipeNomes[2][6][20] = {  { {"Laura"}, {"Matheus"}, {"Raul"}, {"Evelyn"}, {"Luana"}, {"Eduardo"} }, 
                                    { {"Manuela"}, {"Eloah"}, {"Rebbeca"}, {"Heitor"}, {"Igor"}, {"Ana"} }  };
    ...
    if(cont[0] > cont[1])
        printf("A equipe com mais mulheres e a equipe 1\n");
    else if(cont[0] < cont[1])
        printf("A equipe com mais mulheres e a equipe 2\n");
    else
